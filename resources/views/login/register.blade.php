    ...
    <div class="container">
        ...
        <div class="login-page">
            <div class="row">
                ...
                <div class="col">
                    <div class="login">
                        <h3 class="small-title">register an account</h3>
                        <form action="#" class="register-form">
                            <div class="col-md-6 col-sm-6 no-padding-left">
                                <div class="first-name">
                                    <label for="your-first-name">first name <span class="required">*</span>
                                    </label>
                                    <br>
                            ...
                            <div class="col-md-6 col-sm-6 no-padding-right">
                                <div class="last-name">
                                    <label for="your-last-name">Last name <span class="required">*</span>
                                    </label>
                                    <br>
